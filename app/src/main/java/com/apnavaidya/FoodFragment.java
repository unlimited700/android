...
public class FoodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview=inflater.inflate(R.layout.food_layout, container, false);
        expandableListView = (ExpandableListView)rootview.findViewById(R.id.expandableListViewfood);
        showView();
        return rootview;
    }
    void setArgumentss(Bundle bundle)
    {
        ...
        arg=bundle;
        if (bundle.getSerializable("food") != null) {
            Log.i("info","finally got it ");
            expandableListDetail=(HashMap) bundle.getSerializable("food");
        }
        else {
